...
|--------------------------------|-------------------|-------------------|-----------|
| найти запись по ключу          | 67.2 мс, 0.6 МБ   | 72.5 мс, 0.6 МБ   | ×1.08     |
| посчитать строки по условию    | 67.2 мс, 0.6 МБ   | 72.2 мс, 0.6 МБ   | ×1.08     |
| выбрать строки по условию      | 67.6 мс, 0.6 МБ   | 72.3 мс, 0.7 МБ   | ×1.07     |
| страница из десяти строк       | 0.1 мс, 0.6 МБ    | 0.1 мс, 0.6 МБ    | ×1.72     |
| десять последних с сортировкой | 133.9 мс, 33.1 МБ | 97.5 мс, 0.6 МБ   | **×0.73** |
| обойти всю таблицу             | 66.8 мс, 0.6 МБ   | 82.3 мс, 0.6 МБ   | ×1.23     |
| прочитать таблицу целиком      | 69.0 мс, 29.6 МБ  | 94.1 мс, 35.3 МБ  | ×1.36     |
...
|                                | 500 000 строк, 41 МБ |
|--------------------------------|----------------------|
| `cursor()` по всей таблице     | 785 мс, 0 МБ         |
| `count()`                      | 551 мс, 0 МБ         |
| `orderByDesc('id')->limit(10)` | 1000 мс, 0 МБ        |
| `paginate(10)`                 | 556 мс, 0 МБ         |
